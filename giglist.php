...
<section class="container">
  ...
  <div class="row gig-detail-row">
    <div class="col-md-8">
      <h2 id="giglisth2" <style="color: #5e350d;"><a href="<?php echo $serverpath;?>gigDetails/<?php echo urlencode($opengig['prjTitle']);?>/<?php echo $opengig['prjId'];?>"><?php echo $opengig['prjTitle'];?></a><span class="bid" style="
