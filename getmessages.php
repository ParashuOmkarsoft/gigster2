  ...
  <div class="col-sm-12" >
	...
	for($i=0;$i<$messagethread['count'];$i++)
	{
		...
		$fromuserimg=$fromInfo['profileimage'];
			...
			{
				$cl="style='text-align:left;background-color:#fdebbb;margin-top:10px;vertical-align:top;border-radius: 8px;width: 427px;'";
			}
			else
			{
				$cl="style='background-color:#ffffff;margin-top:10px;vertical-align:top;border-radius: 8px;width: 427px;'";
			}
	?>
