...
<Br/>
      <div class="col-md-12">
        <div class="form-group">
          ...
          <br/>
          <div class="col-sm-12">
            <textarea class="form-control tinpute mtextarea" placeholder="Bid Details" row="10" column="10" required name="proposal" id="proposal" style="width:400px;height:150px;" title="Other than price,sending more information"></textarea>
          </div>
        </div>
        <div class="form-group">
