...
<div class="col-sm-12" >
	...
	for($i=0;$i<$messagethread['count'];$i++)
	{
        ...
        $cl="style='background-color:#ffffff;margin-top:10px;vertical-align:top;border-radius: 8px;float: right;width: 450px;'";
			}
	?>
			...
			?>       <br/>
                  <div class="form-group" <?php echo $cl;?>>
                   <img src="<?php echo $serverpath;?>image.php?image=/<?php echo $buserimage;?>&width=50&height=50&cropratio=1:1" alt="" class="online img-circle" /> <br/>
                    <p class="message"> <a href="#" class="name"><small class="text-muted "><i class="fa fa-clock-o"></i><!-- &nbsp; --> <?php echo gmstrftime("%B %d %Y, %I:%M %p",$messagethread['rows'][$i]['msgon']);?></small><br/>
