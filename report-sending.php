...
if($insertSql)
{
	...
	$messagecontent.="<p>You have received a new status report on your Gig <font style='color:#832b00;'>".$projectdetails['prjTitle']."</font> from <font style='color:#832b00;'>".$projectbidder['username']."</font>.</p>";
