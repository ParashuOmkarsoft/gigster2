  ...
  <div class="row" style="border-bottom: 2px solid #F7BB14;padding: 0px 0px 15px 0px;margin: 0px;">
    ...
    <div class="col-md-4" style="padding: 0;"> 
		...
		$awardednametodisplay="";
      	...
      	<a href="<?php echo $serverpath;?>gigsterInfo/<?php echo mera_url_encode($nametodisplay);?>/<?php echo $gigsterInfo['userId'];?>"> <img src="<?php echo $serverpath;?>image.php?image=/<?php echo $awardedprofilepic;?>&width=75&height=75&cropratio=1:1"class="img-circle"></a> <br>
