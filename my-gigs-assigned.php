...
<title><?php echo $sitename;?>- My Awarded Bids</title>
 ...
 <input id="input-21d" name="rating" value="<?php echo $rt;?>" type="number" class="rating" min=0 max=5 step=0.5 data-size="sm">
        ...
        <div id="msgmodal<?php echo $gigdetails['userId'];?>" class="modal fade  bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="postgigmodel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
                  ...
                  <form class="form-horizontal postgigforminner" action="<?php echo $serverpath;?>sendmessage" target="targetframe" role="form" method="post" >
                    ...
                    <h2 class="source"><?php echo $prjDetails['prjTitle'];?></h2>
                      ...
                      <div class="form-group">
                        ...
                        <br/>
                        <div class="col-md-12">
                          <textarea rows="5" name="message" id="message" class="form-control mtextarea" style="width:100%;" ></textarea>
                        </div>
                      </div>
                      <div class="form-group">
			...
			if($t%2==0)
			{
				$cl="style='text-align: left;background-color: #fdebbb;margin-top: 10px;vertical-align: top;border-radius: 8px;width: 470px;float: left;padding: 15px;'";
			}
			else
			{
				$cl="style='background-color: #ffffff;margin-top: 10px;vertical-align: top;border-radius: 8px;width: 483px;float: right;padding: 15px;'";
			}
			//$updatemessage=@db_query("update btr_messages set isread='1' where msgId=".$messages['rows'][$t]['msgId']);	
			?>
                  <div class="item" <?php echo $cl;?>> <img src="<?php echo $serverpath;?>image.php?image=/<?php echo $buserimage;?>&width=50&height=50&cropratio=1:1" alt="<?php echo get_user_name($msgfrom);?>" class="img-circle" style="float:none;margin-top:0px;"/>
