        ...
        <div class="row">
		  ...
		  ?>
            ...
            <a href="#statusmodal<?php echo $prjDetails['prjId'];?>" data-toggle="modal" title="Send Status Report"> <div class="progress">
             <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $projectstatus;?>%;"> <span class="sr-only"><span class="sr-only"><?php echo $projectstatus; ?>%</span></span></div> 
            </div></a>
          </div>
        </div>
      </div>
