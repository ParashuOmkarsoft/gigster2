...
<html lang="en">
  ...
  <div>
    <span class="btn btn-default btn-file" style="background: none;box-shadow: none;border: none;"><span class="fileinput-new"></span><a href="#" class="btn btn-default fileinput-exists">upload</a><img src="images/pencil.png"><input type="file" name="profileimage" id="profileimage" /></span>
