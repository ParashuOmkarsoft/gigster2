...
<?php		  }
        ...
        <?php
          ...
          <input type="hidden" name="frmaction" id="frmaction" value="updateinfo" />
           <div class="col-md-6">
          	<div class="form-group">
            	<label class="col-sm-4 profile-inpute">First Name</label>              
              <input type="text" name="fname" id="fname" class="form-control profile-text" value="<?php echo $uInfo['fname'];?>" />                
            </div>
          	<div class="form-group">
            <label class="col-sm-4 profile-inpute">Last Name</label>
          ...
          <script type="text/javascript">$("#skills").select2({tags:[<?php echo strtolower($tags);?>]});</script>
			...
			<div class="form-group">
            <label class="col-sm-4 profile-inpute">City</label>
            <div style="margin-bottom: 12px;">
                	<input type="text" name="city" id="city" class="form-control profile-text" value="<?php echo $uInfo['city'];?>" />
            </div>
            </div>
            <div class="form-group">
            	   <label class="col-sm-4 profile-inpute">Country</label>
                <?php 
        ...
        <div class="">
            ...
            <div style="margin-bottom: 12px; margin-top: 15px;padding-left: 9px;">
				    ...
				    <label class="col-sm-4 profile-inpute" style="margin-right:44px;padding:0px;margin-top: 11px;">Notifications</label>
            ...
            <div style="margin-bottom: 12px; margin-top: 15px;padding-left: 9px;">
				    ...
				    <label class="col-sm-4 profile-inpute" style="margin-right:57px;padding:0px;margin-top: 11px;">Sync Image</label>
