...
<div class="container-fluid" style="max-width: 1227px;padding:0px;margin-left: 17px;">
<div class="row-fluid">
    <div class="span12">
      <div class="row-fluid">
...
<div class="container-fluid" style="max-width: 1227px;padding:0px;padding-bottom: 70px;margin-left: 17px;">
  <div class="row-fluid">
    <div class="span12">
      <div class="row-fluid">
