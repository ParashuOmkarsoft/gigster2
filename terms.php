  ...
  <?php include('top-menu.php'); ?>  
      ...
      <div class="row firstdinner">
       ...
       <div class="row secondinner">
        <div class="col-md-12">
         <span id="p-name">GLOSSARY</span><br><br> 
...
<br><span class="bullet">●</span> PASSWORD: THE “PASSWORD“ IS A CONFIDENTIAL PIECE OF INFORMATION WHICH THE USER MUST KEEP SECRET; ALONG WITH THE USERNAME, IT ALLOWS THE USER TO PROVE THEIR IDENTITY.
    ...
    <div class="row secondinner">
        <div class="col-md-12">
         <span id="p-name">PURPOSE AND AREAS OF APPLICATION</span><br><br>
    ...
    <div class="row secondinner">
        <div class="col-md-12">
         <span id="p-name">USE OF THE PLATFORM</span><br><br>
    ...
    <div class="row secondinner">
        <div class="col-md-12">
         <span id="p-name">ACCESS TO THE SERVICE</span><br><br>
